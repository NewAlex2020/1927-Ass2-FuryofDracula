...
<script charset="utf-8">
    JS.require('OpenLearning', 'jQuery.ui', 'Instrumentation', 'Utilities', function() {
        ...
        Instrumentation.addProperties({
            pagePath: "unsw/courses/COMP1927-2013S2/FuryOfDracula/Files_v0.02/Makefile"
        });
    ...
    <script type="text/javascript" charset="utf-8">
        JS.require('jQuery', function() {
            $(document).ready(function() {
                ...
                var pageId = '523ffacfb919662b177a5777';
...
<script type="text/javascript" charset="utf-8">
	...
	var AddSubpage = {
		currentPage: 'https://www.openlearning.com/unsw/courses/COMP1927-2013S2/FuryOfDracula/Files_v0.02/Makefile/',
		pageToCreate: '',
		openModal: function() {
	...
	<div class="modal-body">
		<p class="modal-content">
			<form id="addSubpageForm">
				...
				<div id="addSubpageURLPreview">https://www.openlearning.com/unsw/courses/COMP1927-2013S2/FuryOfDracula/Files_v0.02/Makefile/<span id="addSubpageDynamicURL" style="color: #00a;"></span></div>
			</form>
		</p>
	</div>
	<div class="modal-footer">
...
<section class="page-section">
	...
	<script type="text/javascript" charset="utf-8">
		JS.require('jQuery','dust','API', function() {
			$.getScript('https://www.openlearning.com/media-455534c/lib/dust/compiled_templates/page.dust').done(function() {
				API.get('page/relatedTo/unsw/courses/COMP1927-2013S2/FuryOfDracula/Files_v0.02/Makefile').done(function( res ) {
	...
	<ul id="related-pages">
		...
		<div class="input-append">
		  <input type="hidden" name="relatedToPage" value="unsw/courses/COMP1927-2013S2/FuryOfDracula/Files_v0.02/Makefile">
			...
			JS.require('API', 'jQuery', '$.fn.tooltip', function (API, $) {
                ...
                <div id="page-header-container">
                    ...
                    <h1 class="title">
                        ...
                        <a href="https://www.openlearning.com/unsw/courses/COMP1927-2013S2/FuryOfDracula/Files_v0.02/Makefile">
                            <span>Makefile</span>
                        </a>
...
<p>	
	<div style="margin-top: 10px;">
		Download file: <a href="https://www.openlearning.com/unsw/courses/COMP1927-2013S2/FuryOfDracula/Files_v0.02/Makefile?action=download"><img src="https://www.openlearning.com/media-455534c/images/icons/16x16/attach.png" align="absmiddle"> Makefile</a>
		(70 bytes)
	</div>
</p>
...
<div class="pageLastUpdateInfo" style="margin-top: 2px;">
	...
	<a href="https://www.openlearning.com/u/damon.stacey">Damon Stacey</a>
	 &ndash; edited <span class="last-edited-timestamp" title="2013-09-23T08:24:47.322Z">Mon, Sep 23 2013 6:24 p.m.</span>
...
<div class="comments" id="comments-container-main" data-placeholderText="" data-document="523ffacfb919662b177a5777" data-collapsed="0" data-subscription="" data-sorting="time" data-canComment="1" data-disablecommenting="0" data-pinboardEnabled="0">
