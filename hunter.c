...
<script charset="utf-8">
    JS.require('OpenLearning', 'jQuery.ui', 'Instrumentation', 'Utilities', function() {
        ...
        Instrumentation.addProperties({
            pagePath: "unsw/courses/COMP1927-2013S2/FuryOfDracula/Files_v0.02/hunter.c"
        });
    ...
    <script type="text/javascript" charset="utf-8">
        JS.require('jQuery', function() {
            $(document).ready(function() {
                ...
                var pageId = '523ffaceb919662b177a5771';
...
<script type="text/javascript" charset="utf-8">
	...
	var AddSubpage = {
		currentPage: 'https://www.openlearning.com/unsw/courses/COMP1927-2013S2/FuryOfDracula/Files_v0.02/hunter.c/',
		pageToCreate: '',
		openModal: function() {
	...
	<div class="modal-body">
		<p class="modal-content">
			<form id="addSubpageForm">
				...
				<div id="addSubpageURLPreview">https://www.openlearning.com/unsw/courses/COMP1927-2013S2/FuryOfDracula/Files_v0.02/hunter.c/<span id="addSubpageDynamicURL" style="color: #00a;"></span></div>
			</form>
		</p>
	</div>
	<div class="modal-footer">
...
<section class="page-section">
	...
	<script type="text/javascript" charset="utf-8">
		JS.require('jQuery','dust','API', function() {
			$.getScript('https://www.openlearning.com/media-455534c/lib/dust/compiled_templates/page.dust').done(function() {
				API.get('page/relatedTo/unsw/courses/COMP1927-2013S2/FuryOfDracula/Files_v0.02/hunter.c').done(function( res ) {
	...
	<ul id="related-pages">
		...
		<div class="input-append">
		  <input type="hidden" name="relatedToPage" value="unsw/courses/COMP1927-2013S2/FuryOfDracula/Files_v0.02/hunter.c">
...
<div id="course-info">
			...
			JS.require('API', 'jQuery', '$.fn.tooltip', function (API, $) {
                ...
                <div id="page-header-container">
                    ...
                    <h1 class="title">
                        ...
                        <a href="https://www.openlearning.com/unsw/courses/COMP1927-2013S2/FuryOfDracula/Files_v0.02/hunter.c">
                            <span>hunter.c</span>
                        </a>
	...
	<pre class="prettyprint linenums">#include &quot;game.h&quot;
#include &quot;HunterView.h&quot;
#include &quot;hunter.h&quot;

void decideMove( HunterView gameState ) {
   registerBestPlay( &quot;42&quot;, &quot;Hello World&quot; );
   while( 1 );
}</pre>
...
<p>	
	<div style="margin-top: 10px;">
		Download file: <a href="https://www.openlearning.com/unsw/courses/COMP1927-2013S2/FuryOfDracula/Files_v0.02/hunter.c?action=download"><img src="https://www.openlearning.com/media-455534c/images/icons/16x16/attach.png" align="absmiddle"> hunter.c</a>
		(165 bytes)
	</div>
</p>
...
<div class="pageLastUpdateInfo" style="margin-top: 2px;">
	...
	<a href="https://www.openlearning.com/u/damon.stacey">Damon Stacey</a>
	 &ndash; edited <span class="last-edited-timestamp" title="2013-09-23T08:24:46.413Z">Mon, Sep 23 2013 6:24 p.m.</span>
...
<div class="comments" id="comments-container-main" data-placeholderText="" data-document="523ffaceb919662b177a5771" data-collapsed="0" data-subscription="" data-sorting="time" data-canComment="1" data-disablecommenting="0" data-pinboardEnabled="0">
